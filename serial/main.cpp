/*
	...
	Program Usage:
		aes encrypt {KEYSIZE=128,192,256} "ENCRYPTION_KEY" "PLAINTEXT"
		aes decrypt {KEYSIZE=128,192,256} "ENCRYPTION_KEY" "CIPHERTEXT"

	Linux Compilation Command: g++ main.cpp -o aes -O3
*/
...
void printHelpText() {
	std::cout << "Usage:\n\
aes encrypt KEYSIZE \"ENCRYPTION_KEY\" \"PLAINTEXT\"\n\
aes decrypt KEYSIZE \"ENCRYPTION_KEY\" \"CIPHERTEXT\"\n\
eg. aes encrypt 128 this_is_the_key_ \"This is some random plaintext. Unlike the key, it can be of any length\".\n\
\n\
Notes:\n\

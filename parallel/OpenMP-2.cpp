/*
	...
	Linux Compilation Command: g++ -fopnemp OpenMP-2.cpp -o aesomp2 -O3
*/
...
void subBytes(std::vector<std::bitset<8>>& inText) {
	...
	#pragma omp for ordered schedule(static,1)		// Parallelize the for loop, scheduling each thread only 1 chunk of the array at a time
	for (int i = 0; i < 16; ++i) {
